...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    public ViewProductDetailJPanel(JPanel upc, Product p) {
        ...
        availTxtField.setText(Integer.toString(p.getAvailability()));
    }
    ...
    private void initComponents() {
        ...
        availTxtField.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        add(availTxtField, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 210, 159, -1));
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        product.setAvailability(Integer.parseInt(availTxtField.getText()));
